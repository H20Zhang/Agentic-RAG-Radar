...
**Grounding.** Abstract-grounded first pass. The abstract also reports BM25 as statistically indistinguishable from READ, so the visual should not be read as evidence that agentic composition itself is proven necessary.
