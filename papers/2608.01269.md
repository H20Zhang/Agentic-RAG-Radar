...
**Grounding brief:** [`assets/visuals/prompts/2608.01269.md`](../assets/visuals/prompts/2608.01269.md)

**What to notice.** The graph/hierarchy is the substrate, not the main contribution. The key layer is a policy that detects context gaps and chooses depth-oriented versus breadth-oriented evidence acquisition.
