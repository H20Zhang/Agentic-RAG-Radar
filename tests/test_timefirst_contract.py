...
class TimeFirstContractTest(unittest.TestCase):
    ...
    def test_period_window_drift_is_rejected(self):
        mutations = (
            ("2026-08-18—2026-08-24", "2026-08-14—2026-08-21", "last-7-days"),
            ("2026-07-26—2026-08-24", "2026-07-22—2026-08-21", "last-30-days"),
        )
        for old, new, expected in mutations:
            with self.subTest(expected=expected):
                zh, en = make_pair(1)
    ...
    def test_period_windows_have_exact_inclusive_cardinality(self):
        zh, en = make_pair(1)
        zh = zh.replace("2026-08-18—2026-08-24", "2026-08-14—2026-08-21", 1)
        en = en.replace("2026-08-18—2026-08-24", "2026-08-14—2026-08-21", 1)
        self.assertTrue(
    ...
    def test_period_windows_share_one_synthesis_endpoint(self):
        zh, en = make_pair(1)
        zh = zh.replace("2026-08-18—2026-08-24", "2026-08-14—2026-08-20", 1)
        en = en.replace("2026-08-18—2026-08-24", "2026-08-14—2026-08-20", 1)
        self.assertTrue(
